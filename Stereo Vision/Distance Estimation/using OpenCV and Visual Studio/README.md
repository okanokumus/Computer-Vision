Distance estimation of a person through the stereo camera. Two cameras are used to camera calibration and 6x9 checkerboard pattern (it is available in this repo)are used for prework. 
